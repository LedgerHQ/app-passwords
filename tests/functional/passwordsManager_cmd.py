...
from ragger.firmware.nbgl.positions import EUROPA_BUTTON_ABOVE_LOWER_MIDDLE, \
...
class PasswordsManagerCommand:
    ...
    def approve(self):
        ...
        elif self.firmware == Firmware.EUROPA:
            self.transport.finger_touch(*EUROPA_BUTTON_ABOVE_LOWER_MIDDLE)
        else:
