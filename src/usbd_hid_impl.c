...
const uint8_t const HID_ReportDesc_kbd[] = {
...
static __ALIGN_BEGIN const uint8_t const USBD_CfgDesc[] __ALIGN_END = {
    ...
    sizeof(
        HID_ReportDesc_kbd), /*wItemLength: Total length of Report descriptor*/
    0x00,
...
/* USB HID device Configuration Descriptor */
__ALIGN_BEGIN const uint8_t const USBD_HID_Desc_kbd[] __ALIGN_END = {
    /******************** Descriptor of HID *************************/
    0x09,                /*bLength: HID Descriptor size*/
    HID_DESCRIPTOR_TYPE, /*bDescriptorType: HID*/
    0x11,                /*bHIDUSTOM_HID: HID Class Spec release number*/
    0x01, 0x21, /*bCountryCode: Hardware target country*/ // 0x21: US, 0x08: FR,
                                                          // 0x0D: ISO Intl
    0x01, /*bNumDescriptors: Number of HID class descriptors to follow*/
    0x22, /*bDescriptorType*/
    sizeof(
...
/* USB Standard Device Descriptor */
static __ALIGN_BEGIN const uint8_t const
    USBD_DeviceQualifierDesc[] __ALIGN_END = {
...
/**
  ...
  */
static uint8_t *USBD_DeviceDescriptor(USBD_SpeedTypeDef speed,
                                      uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_LangIDStrDescriptor(USBD_SpeedTypeDef speed,
                                         uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_ProductStrDescriptor(USBD_SpeedTypeDef speed,
                                          uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_ManufacturerStrDescriptor(USBD_SpeedTypeDef speed,
                                               uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_SerialStrDescriptor(USBD_SpeedTypeDef speed,
                                         uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_ConfigStrDescriptor(USBD_SpeedTypeDef speed,
                                         uint16_t *length) {
    UNUSED(speed);
...
/**
  ...
  * @retval Pointer to descriptor buffer
  */
static uint8_t *USBD_InterfaceStrDescriptor(USBD_SpeedTypeDef speed,
                                            uint16_t *length) {
    UNUSED(speed);
...
uint8_t *USBD_HID_GetReportDescriptor_impl(uint16_t *len) {
    ...
    case 0:
        ...
        USBD_LL_OpenEP(&USBD_Device, 0x81, USBD_EP_TYPE_INTR, 8);

        USBD_LL_OpenEP(&USBD_Device, 0x01, USBD_EP_TYPE_INTR, 8);
...
const USBD_DescriptorsTypeDef const HID_Desc = {
    USBD_DeviceDescriptor,          USBD_LangIDStrDescriptor,
    USBD_ManufacturerStrDescriptor, USBD_ProductStrDescriptor,
    USBD_SerialStrDescriptor,       USBD_ConfigStrDescriptor,
    USBD_InterfaceStrDescriptor,    NULL,
};
...
static const USBD_ClassTypeDef const USBD_HID = {
    ...
    NULL,                                                 /*SOF */
    NULL, NULL, USBD_GetCfgDesc_impl, USBD_GetCfgDesc_impl,
    USBD_GetCfgDesc_impl, USBD_GetDeviceQualifierDesc_impl,
};
