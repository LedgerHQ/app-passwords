...
#define SETTINGS_FIRST_PAGE_EUROPA_OPTIONS_NUMBER  4
#define SETTINGS_SECOND_PAGE_STAX_OPTIONS_NUMBER   1
#define SETTINGS_SECOND_PAGE_EUROPA_OPTIONS_NUMBER 2
...
static bool display_settings_navigation(uint8_t page, nbgl_pageContent_t *content) {
    if (page == 0) {
...
#else   // TARGET_STAX
        content->switchesList.nbSwitches = SETTINGS_FIRST_PAGE_EUROPA_OPTIONS_NUMBER;
#endif  // TARGET_STAX
        ...
        switches[0] = (nbgl_layoutSwitch_t){.initState = has_charset_option(EXT_SYMBOLS_BITFLAG),
                                            ...
                                            .tuneId = TUNE_TAP_CASUAL};
        index_after_charset++;
        content->switchesList.nbSwitches = SETTINGS_SECOND_PAGE_EUROPA_OPTIONS_NUMBER;
#else   // TARGET_EUROPA
