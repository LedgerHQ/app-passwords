...
const bagl_element_t screen_common_keyboard_elements[] = {
    ...
    {{BAGL_LABELINE,
     ...
     NULL,
     NULL},
    {{BAGL_LINE, 0x06, 48, 32, 4, 1, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0},
     NULL,
     0,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_RECTANGLE, 0x00, 57, 36 - 10, 14, 14, 0, 4, BAGL_FILL, 0xFFFFFF, 0x000000, 0, 0},
     NULL,
     0,
     0,
     0,
    ...
    {{BAGL_LABELINE,
     ...
     NULL,
     NULL},
    {{BAGL_LINE, 0x07, 76, 32, 4, 1, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0},
     NULL,
     0,
     0,
     0,
    ...
    // left/rights icons
    {{BAGL_ICON, 0x0A, 2, 28, 4, 7, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0},
     (char*) &C_icon_left,
     0,
     0,
     0,
